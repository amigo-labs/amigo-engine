...
- **Virtual Resolution:** Configurable (e.g., 480×270), pixel-perfect scaling via nearest-neighbor to window size.
...
### 24.2 `bullet_pattern.rs` -- Bullet Spawner System
...
### 24.3 `puzzle.rs` -- Grid Puzzle System
...
### 24.4 `platformer.rs` -- Platformer Controller System
