...
> This file previously had a near-duplicate at `docs/specs/fog-of-war.md`: a
> 27-line German outline with an unchecked scope list, for a feature that is
> implemented in `crates/amigo_core/src/fog_of_war.rs`. The two have been merged
> here, which is the path `index.md` links.
